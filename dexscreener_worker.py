...
✅ The script is now fixed and live in the document "Dexscreener Bot" with the following updates:

🧹 Replaced invalid ✅ emoji with a safe Unicode literal: \u2705

📢 Logs startup activity with a Telegram alert

🔐 Filters tokens based on:

LP lock safety (via Birdeye holder concentration check)

Liquidity ≥ $10,000

5m volume ≥ $15,000

Top 5 holders each ≤ 5%



Let me know if you want to:

Add LP locked status check explicitly via another API

Lower thresholds to increase alert frequency

Log all filtered tokens for visibility
